...
try {
    for (var _iterator = apps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        a.element ? getRenderFunc(a)() : null;
         true ? module.hot.accept(getRenderFunc(a)()) : null;
    }
} catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
...
if (true) {
  module.exports = __webpack_require__("./node_modules/react-hot-loader/lib/prod/patch.prod.js");
} else {
...
/***/ "./node_modules/react-hot-loader/lib/prod/patch.prod.js":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("./assets/js/react/index.jsx");
module.exports = __webpack_require__("./assets/js/modules/index.js");
